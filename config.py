...
# tf.app.flags.DEFINE_string("pred_file", 'resource/test_data/predict.txt', "test data.")
...
tf.app.flags.DEFINE_string("word_embedding_file", '/Users/huige/Desktop/deeplearning/wiki.zh.vec', "extra word embeddings.")
